...
$a_uniacid=pdo_getcolumn('account_wxapp',array('uniacid'=>$_W['uniacid']),'a_uniacid');
if($a_uniacid){
	$_W['uniacid']=$a_uniacid;
}
...
if (!empty($_W['account']['oauth']) && $_W['account']['oauth']['level'] == '4' && $_GPC['from']!='wxapp') {
