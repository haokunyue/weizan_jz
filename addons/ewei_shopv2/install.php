...
CREATE TABLE `ims_ewei_shop_badv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE `ims_ewei_shop_city_express` (
  ...
  `start_fee` decimal(10,2) DEFAULT NULL,
  `start_km` int(11) DEFAULT NULL,
  `pre_km` int(11) DEFAULT NULL,
  `pre_km_fee` decimal(10,2) DEFAULT NULL,
  `fixed_km` int(11) DEFAULT NULL,
  ...
  `is_dispatch` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `ims_ewei_shop_creditshop_goods` (
  ...
  `maxpacketmoney` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_type` (`type`),
...
INSERT INTO `ims_ewei_shop_express` VALUES ('8', '汇通快运', 'huitongkuaidi', '1', '0', 'JH_012');
...
INSERT INTO `ims_ewei_shop_express` VALUES ('78', '邮政包裹挂号信', 'youzhengguonei', '1', '0', 'JH_077');
...
CREATE TABLE `ims_ewei_shop_goods` (
  ...
  `newgoods` tinyint(3) NOT NULL,
  `officthumb` varchar(512) DEFAULT NULL,
  `saleupdate` tinyint(3) DEFAULT NULL,
  `verifygoodstype` tinyint(1) NOT NULL,
  `isforceverifystore` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_pcate` (`pcate`),
  KEY `idx_ccate` (`ccate`),
...
CREATE TABLE `ims_ewei_shop_goods_spec` (
  ...
  `displayorder` int(11) DEFAULT '0',
  `propId` varchar(255) DEFAULT '',
  `iscycelbuy` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_goodsid` (`goodsid`),
  KEY `idx_displayorder` (`displayorder`)
...
CREATE TABLE `ims_ewei_shop_goods_spec_item` (
  ...
  `valueId` varchar(255) DEFAULT '',
  `virtual` int(11) DEFAULT '0',
  `cycelbuy_periodic` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
...
CREATE TABLE `ims_ewei_shop_lottery` (
  ...
  `award_start` int(11) DEFAULT NULL,
  `award_end` int(11) DEFAULT NULL,
...
CREATE TABLE `ims_ewei_shop_merch_bill` (
  ...
  `creditstatus` tinyint(3) NOT NULL,
  `creditrate` int(10) NOT NULL,
  `creditnum` int(10) NOT NULL,
  `creditmoney` decimal(10,2) NOT NULL,
  `passcreditnum` int(10) NOT NULL,
  `passcreditmoney` decimal(10,2) NOT NULL,
  `isbillcredit` int(10) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_merchid` (`merchid`),
  KEY `idx_status` (`status`)
...
CREATE TABLE `ims_ewei_shop_merch_user` (
  ...
  `iscredit` tinyint(3) NOT NULL,
  `creditrate` int(10) NOT NULL,
  `iscreditmoney` int(3) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_uniacid` (`uniacid`),
  KEY `idx_status` (`status`),
...
CREATE TABLE `ims_ewei_shop_order` (
  ...
  `print_template` text,
  `city_express_state` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `ims_ewei_shop_order_goods` (
  ...
  `esheetprintnum` int(11) NOT NULL,
...
CREATE TABLE `ims_ewei_shop_package` (
  ...
  `deleted` tinyint(3) NOT NULL DEFAULT '0',
  `displayorder` int(11) NOT NULL DEFAULT '0',
  `dispatchtype` tinyint(3) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `ims_ewei_shop_payment` (
  ...
  `qpay_signtype` tinyint(1) NOT NULL,
...
INSERT INTO `ims_ewei_shop_plugin` VALUES ('3', '3', 'commission', 'biz', '分销', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/commission.jpg', '', '0', '0', '0');
...
INSERT INTO `ims_ewei_shop_plugin` VALUES ('42', '46', 'pc', 'sale', 'PC端', '1.0', '易福', '1', '../addons/ewei_shopv2/static/images/pc.jpg', '', '0', '0', '1');
...
INSERT INTO `ims_ewei_shop_plugin` VALUES ('45', '46', 'app', 'help', '小程序', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/app.jpg', '', '0', '0', '1');
...
INSERT INTO `ims_ewei_shop_plugin` VALUES ('48', '51', 'cycelbuy', 'sale', '周期购', '1.0', '官方', '1', '../addons/ewei_shopv2/static/images/cycelbuy.jpg', '', '0', '0', '1');
...
CREATE TABLE `ims_ewei_shop_task_list` (
  ...
  `member_group` text,
  `auto_pick` tinyint(1) DEFAULT NULL,
  `keyword_pick` varchar(20) DEFAULT NULL,
