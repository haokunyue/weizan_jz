define(['jquery.ui', '../../../../static/js/web/goods_selector.js'], function (ui, gSelector) {
    ...
    modal.initNavs = function () {
        modal.setNavs();
        var navgroup = {
            0: ['listmenu', 'richtext', 'title', 'line', 'blank', 'menu', 'menu2', 'picture', 'banner', 'picturew', 'coupon'],
            ...
            4: ['detail_swipe','detail_info','detail_sale','detail_spec','detail_package','detail_shop','detail_buyshow','detail_comment','detail_navbar','pictures','icongroup','audio','goods']
        };
