...
class Goods_EweiShopV2Page extends AppMobilePage 
{
	...
	public function get_detail() 
	{
		...
		{
			$image_content = $this->curl_file_get_contents($gv);
			$img_info = imagecreatefromstring($image_content);
	...
	public function get_picker() 
	{
		...
		app_json(array( 'goods' => $goods, 'specs' => $specs, 'options' => $options, 'diyform' => array('fields' => $appDatas['fields'], 'lastdata' => $appDatas['f_data']) ));
	}
