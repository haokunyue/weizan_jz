...
class Finance_EweiShopV2Page extends AppMobileAuthPage 
{
	...
	{
		app_json(array( 'perm' => array('finance_recharge' => cv('finance.log.recharge'), 'finance_withdraw' => cv('finance.log.withdraw'), 'finance_credit2' => cv('finance.credit.credit2')) ));
	}
	...
	public function recharge() 
	{
		...
		app_json(array( 'member' => array('id' => $member['id'], 'nickname' => $member['nickname'], 'avatar' => tomedia($member['avatar']), 'credit1' => $member['credit1'], 'credit2' => $member['credit2']), 'perm' => array('recharge_credit1' => cv('finance.recharge.credit1'), 'recharge_credit2' => cv('finance.recharge.credit2')) ));
	}
}
?>