...
class Account_EweiShopV2Page extends AppMobilePage 
{
	...
	public function login() 
	{
		...
		app_json(array( 'token' => $token, 'expire' => $this->expire, 'member' => array('id' => $member['id'], 'mobile' => $member['mobile'], 'salt' => $member['salt'], 'nickname' => $member['nickname'], 'avatar' => $member['avatar'], 'openid' => $member['openid']) ));
	}
