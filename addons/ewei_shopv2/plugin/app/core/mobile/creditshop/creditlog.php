...
class Creditlog_EweiShopV2Page extends AppMobilePage 
{
	public function main() 
	{
		...
		app_json(array('credit' => $credit, 'member' => $member, 'is_openmerch' => $is_openmerch));
	}
	public function getlist() 
	{
		...
		app_json(array('total' => $total, 'list' => $list, 'pagesize' => $psize, 'credit' => $credit, 'next_page' => ceil($total / $psize)));
	}
}
?>