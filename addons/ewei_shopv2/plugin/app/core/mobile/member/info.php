...
class Info_EweiShopV2Page extends AppMobilePage 
{
	...
	public function main() 
	{
		...
		$result = array( 'member' => $memberArr, 'diyform' => array('template_flag' => $diyform_data['template_flag'], 'f_data' => $diyform_data['f_data'], 'fields' => $diyform_data['fields']) );
	...
	public function submit() 
	{
		...
		else 
		{
			...
			$arr = array('realname' => trim($memberdata['realname']), 'weixin' => trim($memberdata['weixin']), 'birthyear' => intval($memberdata['birthyear']), 'birthmonth' => intval($memberdata['birthmonth']), 'birthday' => intval($memberdata['birthday']), 'province' => trim($memberdata['province']), 'city' => trim($memberdata['city']), 'datavalue' => trim($memberdata['datavalue']), 'mobile' => intval($memberdata['mobile']));
