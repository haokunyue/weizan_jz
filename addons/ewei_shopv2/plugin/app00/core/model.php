...
if (!class_exists('AppModel')) {
	class AppModel extends PluginModel
	{
		...
		{
			$needHandle = array('iconurl', 'imgurl', 'leftnavimg', 'rightnavimg', 'thumb');
		...
		public function getAuth()
		{
			...
			load()->func('communication');
			$request = ihttp_get(EWEI_SHOPV2_AUTH_WXAPP . 'index/platform/getAuth.html?uniacid=' . $_W['uniacid']);
			if ($request['code'] != 200) {
		...
		public function getRelease($authid)
		{
			...
			global $_W;
			load()->func('communication');
			$request = ihttp_get(EWEI_SHOPV2_AUTH_WXAPP . 'index/platform/getRelease.html?uniacid=' .  $_W['uniacid']);
			if ($request['code'] != 200) {
		...
		public function getReleaseList()
		{
			...
			load()->func('communication');
			$request = ihttp_get(EWEI_SHOPV2_AUTH_WXAPP . 'index/platform/getReleaseList?uniacid=' . $_W['uniacid']);
