...
class Shop_EweiShopV2Page extends AppMobilePage
{
	public function get_shopindex()
	{
		...
		app_json(array('uniacid' => $uniacid, 'sorts' => array_values($newsorts), 'goodsstyle' => $goodsstyle, 'copyright' => !empty($copyright) && !empty($copyright['copyright']) ? $copyright['copyright'] : ''));
	}
