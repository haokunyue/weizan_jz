...
class Index_EweiShopV2Page extends AppMobilePage
{
	...
	public function detail()
	{
		...
		app_json(array('order' => $order, 'goods' => $allgoods, 'address' => $address, 'express' => $express, 'carrier' => $carrier, 'store' => $store, 'stores' => $stores, 'shop' => $shop, 'customer' => $_W['shopset']['app']['customer']));
	}
