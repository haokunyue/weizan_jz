...
class Selecturl_EweiShopV2Page extends WebPage 
{
	...
	public function main() 
	{
		...
		if( $platform ) 
		{
			...
			$allUrls[0]["list"][] = array( "name" => "店铺街入口", "url" => mobileUrl(NULL, NULL, $full), "url_wxapp" => "/pages/changce/merch/index" );
			$allUrls[0]["list"][] = array( "name" => "店铺街入驻", "url" => mobileUrl(NULL, NULL, $full), "url_wxapp" => "/pages/changce/merch/apply" );
			$allUrls[0]["list"][] = array( "name" => "文章营销", "url" => mobileUrl(NULL, NULL, $full), "url_wxapp" => "/pages/changce/article/list" );
			$allUrls[0]["list"][] = array( "name" => "积分签到", "url" => mobileUrl(NULL, NULL, $full), "url_wxapp" => "/pages/changce/sign/index" );
		...
		if( $platform != "wxapp_tabbar" && $platform != "" && p("groups") ) 
		{
