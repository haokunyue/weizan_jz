...
<form <?php if(cv('sysset.sms.set')) { ?>method="post"<?php  } ?> class="form-horizontal form-validate">
    ...
    <div class="form-group-title">聚合数据<small style="padding-left: 10px;"><a target="_blank" href="http://www.juhe.cn">立即申请</a></small>
        <span class="pull-right">
    ...
    <div class=" sms-juhe" style="<?php  if(empty($item['juhe'])) { ?>display: none;<?php  } ?>">
        <div class="form-group">
            <label class="col-sm-2 control-label must">App Key</label>
    ...
    <div class="form-group-title">阿里大于(老用户)<small style="padding-left: 10px;"><a target="_blank" href="javascript:;">暂停申请</a></small>
        <span class="pull-right">
    ...
    <div class=" sms-dayu" style="<?php  if(empty($item['dayu'])) { ?>display: none;<?php  } ?>">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label must">App Secret</label>
            <div class="col-sm-9 col-xs-12">
    ...
    <div class="form-group-title">亿美软通 <small>(<span class="text-danger">余额: <span  id="num_emay">--</span></span>)</small><small style="padding-left: 10px;"><a target="_blank" href="http://www.emay.cn">立即申请</a></small>
            <span class="pull-right">
    ...
    <div class=" sms-emay" style="<?php  if(empty($item['emay'])) { ?>display: none;<?php  } ?>">
        <div class="form-group">
            <label class="col-sm-2 control-label must">网关地址</label>
            <div class="col-sm-9 col-xs-12">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label must" style="padding-top: 0;">序列号serialNumber</label>
            <div class="col-sm-9 col-xs-12">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label must">SESSION KEY</label>
            <div class="col-sm-9 col-xs-12">
        ...
        <div class="form-group">
            <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">超时时间设置</label>
            <div class="col-sm-9 col-xs-12">
                <div class='input-group'>
        ...
        <div class="form-group">
            <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 control-label">余额预警</label>
            <div class="col-sm-9 col-xs-12">
                <div class='input-group'>
                    ...
                    <input type="number" name="emay_mobile" class="form-control" value="<?php  echo $item['emay_mobile'];?>" />
                </div>
