    ...
    <table class="table table-responsive table-hover">
        ...
        <tr>
            ...
            <td>
                ...
                <?php if(cv('sysset.weixintemplate.delete')) { ?><a class='btn btn-default  btn-sm'  data-toggle='ajaxRemove' href="<?php  echo webUrl('sysset/weixintemplate/delete', array('id' => $row['template_id']))?>" data-confirm="确认删除此模板吗？" ><i class='fa fa-trash'></i> 删除</a><?php  } ?>
        </tr>
        <?php  } } ?>
