<?php defined('IN_IA') or exit('Access Denied');?><div class="form-group">
    <label class="col-sm-2 control-label">是否开启商品详情二维码分享</label>
...
<div class="form-group">
    <label class="col-sm-2 control-label">分销订单商品详情</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('commission.set.edit')) { ?>
...
<div class="form-group">
    <label class="col-sm-2 control-label">分销订单购买者详情</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('commission.set.edit')) { ?>
...
<div class="form-group">
    <label class="col-sm-2 control-label">是否关闭分销中心推广二维码</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('commission.set.edit')) { ?>
...
<div class="form-group">
    <label class="col-sm-2 control-label">推广二维码用超级海报的关注海报</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('commission.set.edit')) { ?>
...
<div id="qrcode" <?php  if(empty($data['qrcode'])) { ?>style="display: none"<?php  } ?>>
<div class="col-sm-5">
...
<div class="col-sm-7">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('commission.set.edit')) { ?>
            <textarea class='form-control' name="data[qrcode_content]" rows="6"><?php  echo $data['qrcode_content'];?></textarea>
            <?php  } else { ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 col-xs-12">
            <?php if(cv('commission.set.edit')) { ?>
            <textarea class='form-control' name="data[qrcode_remark]" rows="6"><?php  echo $data['qrcode_remark'];?></textarea>
            <?php  } else { ?>
            {$data['qrcode_remark ']}
            <?php  } ?>
        </div>
