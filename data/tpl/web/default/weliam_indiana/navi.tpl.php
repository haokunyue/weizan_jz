...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'display') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('navi',array('op' =>'display'))?>">导航</a></li>
	<li<?php  if(empty($adv['id']) && $operation == 'post') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('navi',array('op' =>'post'))?>">添加导航</a></li>
	<?php  if(!empty($adv['id']) &&  $operation == 'post') { ?><li  class="active"><a href="<?php  echo $this->createWebUrl('navi',array('op' =>'post','id'=>$adv['id']))?>">编辑导航</a></li><?php  } ?>
</ul>
		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td class="text-right">
						<a href="<?php  echo $this->createWebUrl('navi', array('op' => 'post', 'id' => $adv['id']))?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="修改"><i class="fa fa-edit"></i></a>
						<a href="<?php  echo $this->createWebUrl('navi', array('op' => 'delete', 'id' => $adv['id']))?>"class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="删除"><i class="fa fa-times"></i></a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" id='advname' name="advname" class="form-control" value="<?php  echo $adv['name'];?>" />
					</div>
				</div>
				<div class="form-group">
