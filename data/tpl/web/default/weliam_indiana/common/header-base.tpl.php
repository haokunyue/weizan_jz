...
<head>
	...
	<link href="<?php echo WELIAM_INDIANA_STATIC;?>css/web/common.css" rel="stylesheet">
	<link href="<?php echo WELIAM_INDIANA_STATIC;?>css/web/style.min.css" rel="stylesheet">
	...
	<script type="text/javascript" src="<?php  echo $_W['siteroot'];?>web/resource/js/app/util.js"></script>
	...
	<script type="text/javascript" src="<?php  echo $_W['siteroot'];?>web/resource/js/app/config.js"></script>
</head>
<body>
