...
<?php  } else { ?>
<ol class="breadcrumb we7-breadcrumb">
	<a href="<?php  echo url('user/display/vice_founder');?>"><i class="wi wi-back-circle"></i> </a>
	<li><a href="<?php  echo url('user/display/vice_founder');?>">副创始人管理</a></li>
	<li>编辑创始人详情</li>
</ol>
<?php  } ?>
<div id="js-user-edit-base" ng-controller="UserProfileDisplay" ng-cloak>
	...
	<div class="btn-group we7-btn-group we7-padding-bottom">
		...
		<?php  } else { ?>
		<a href="<?php  echo url('founder/founderedit/edit_modules_tpl', array('uid' => $_GPC['uid']))?>" class="btn btn-default">应用模板权限</a>
		<?php  } ?>
	...
	<table class="table we7-table table-hover table-form">
		...
		<tr>
			...
			<td><div class="link-group"><a href="javascript:;" data-toggle="modal" data-target="#credit2" ng-click="editInfo('credit2', user.credit2)">修改</a></div></td>
		</tr>
		<tr>
	...
	<div class="modal fade" id="credit2" role="dialog">
		...
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<input type="text" name="credit2" value="<?php  echo $user['credit2'];?>" class="form-control" placeholder="账号余额" />
						<span class="help-block"></span>
					</div>
				</div>
				<div class="modal-footer">
