...
<div class="js-profile-payment" ng-controller="paymentCtrl" ng-cloak>
	<table class="table we7-table table-hover table-form">
		...
		<tr>
			...
			<td>
				<label>
					<input name="" class="form-control" type="checkbox"  style="display: none;" ng-click="saveEdit('delivery')">
					<div ng-class="paysetting.delivery.switch === true ? 'switch switchOn' : 'switch'"></div>
				</label>
			</td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
				<label>
					<input name="" class="form-control" type="checkbox"  style="display: none;" ng-click="saveEdit('credit')">
					<div ng-class="paysetting.credit.switch === true ? 'switch switchOn' : 'switch'"></div>
				</label>
			</td>
			<td></td>
		</tr>
		<tr>
			...
			<td >
				{{  paysetting.alipay.switch === true ? '开启' : '关闭'  }}
			</td>
			<td class="text-center">
				<div class="link-group"><a href="javascript:;" data-toggle="modal" data-target="#zhifubao">修改</a></div>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<div class="related-info">
					...
					<div>支付账号:<?php  echo $_W['uniaccount']['account'];?></div>
				</div>
			</td>
			<td >
				{{  paysetting.wechat.switch != 4 && paysetting.wechat.switch !== false  ? '开启' : '关闭'  }}
			</td>
			<td class="text-center">
				<div class="link-group"><a href="javascript:;" ng-click="check_wechat()">修改</a></div>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				{{  paysetting.wechat_facilitator.switch === true ? '开启' : '关闭'  }}
			</td>
			<td class="text-center">
				<div class="link-group"><a href="javascript:;" class="color-default" data-toggle="modal" data-target="#wechat_fa">修改</a></div>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td >
				{{  paysetting.unionpay.switch === true ? '开启' : '关闭'  }}
			</td>
			<td class="text-center">
				<div class="link-group"><a href="javascript:;" data-toggle="modal" data-target="#yinlian">修改</a></div>
			</td>
		</tr>
		<tr>
			<td >
			...
			<td >
				{{  paysetting.baifubao.switch === true ? '开启' : '关闭'  }}
			</td>
			<td class="text-center">
				<div class="link-group"><a href="javascript:;" data-toggle="modal" data-target="#baidu">修改</a></div>
			</td>
		</tr>
		<tr>
			<td >
			...
			<td>
				{{  paysetting.line.switch === true ? '开启' : '关闭'  }}
			</td>
			<td class="text-center">
				<div class="link-group"><a href="javascript:;" data-toggle="modal" data-target="#huikuan">修改</a></div>
			</td>
		</tr>
	</table>
					...
					<div class="we7-form">
						<div class="form-group">
							...
							<div class="form-controls col-sm-10">
								...
								<input id='radio-1' type="radio" name='alipay[switch]' ng-checked="paysetting.alipay.switch === true" value="true" ng-click="changeSwitch('alipay', true)"/>
								<label for="radio-1">开启 </label>
								<input id='radio-2' type="radio" name='alipay[switch]' ng-checked="paysetting.alipay.switch !== true" value="false" ng-click="changeSwitch('alipay', false)"/>
						...
						<div class="form-group">
							...
							<div class="form-controls col-sm-10">
								<div class="alert alert-warning">
									...
									<a href="https://mp.weixin.qq.com/paymch/readtemplate?t=mp/business/faq_tmpl" class="color-default" target="_blank">申请及详情请查看这里</a>
								</div>
								<div class="alert alert-warning">
									<p>微信支付的接口说明如下：</p>
									<br>
		...
		<div class="we7-modal-dialog modal-dialog">
			<form action="<?php  echo url('profile/payment/save_setting', array('type' => 'unionpay'))?>" enctype="multipart/form-data" method="post" id="form1" >
				...
				<div class="modal-body">
					<div class="we7-form">
						<div class="form-group">
							<label for="" class="control-label col-sm-2">银联支付</label>
							<div class="form-controls col-sm-10">
								<input id='radio-133' type="radio" name='unionpay[switch]' <?php  if($pay_setting['unionpay']['switch'] === true) { ?>checked<?php  } ?> value="true"/>
								<label for="radio-133">开启 </label>
								<input id='radio-266' type="radio" name='unionpay[switch]' <?php  if($pay_setting['unionpay']['switch'] !== true) { ?>checked<?php  } ?> value="false"/>
								<label for="radio-266">关闭 </label>
		...
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="we7-form">
						<div class="form-group">
							<label for="" class="control-label col-sm-2">百度钱包支付</label>
							<div class="form-controls col-sm-10">
								<input id='radio-1223' type="radio" name='paysetting[baifubao][switch]' ng-checked='paysetting.baifubao.switch === true' ng-click="changeSwitch('baifubao', true)"/>
								<label for="radio-1223">开启 </label>
								<input id='radio-21212' type="radio" name='paysetting[baifubao][switch]'  ng-checked='paysetting.baifubao.switch === false' ng-click="changeSwitch('baifubao', false)" />
								<label for="radio-21212">关闭 </label>
		...
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="we7-form">
						<div class="form-group">
							<label for="" class="control-label col-sm-2">汇款支付</label>
							<div class="form-controls col-sm-10">
								<input id='radio-166' type="radio" name='paysetting[line][switch]' ng-checked='paysetting.line.switch === true' ng-click="changeSwitch('line', true)" />
								<label for="radio-166">开启 </label>
								<input id='radio-2667' type="radio" name='paysetting[line][switch]' ng-checked='paysetting.line.switch === false' ng-click="changeSwitch('line', false)"/>
								<label for="radio-2667">关闭 </label>
