			...
			<tr>
				...
				<td>
					<div class="link-group">
						...
						<a href="<?php  echo url('platform/menu/delete', array('id' => $da['id']));?>" class="del" onclick="if(!confirm('<?php  if($da['type'] == 1) { ?>删除默认菜单会清空所有菜单记录，确定吗？<?php  } else { ?>确定删除菜单?<?php  } ?>')) return false;">删除</a>
						<?php  } ?>
					</div>
				</td>
			</tr>
										...
										<li class="js-sortable pre-menu-item" ng-repeat="but in context.group.button" ng-class="{0 : '', 1 : 'active'}[context.activeItem == but ? 1 : 0 ]">
											...
											<div class="sub-pre-menu-box">
												<ul class="sub-pre-menu-list sub-designer-y">
													...
													<li ng-if="but.sub_button.length < 5" ng-click="context.addSubBut(but);" class="sub-js-not-sortable"><i class="fa fa-plus"></i></a>
														</dd>
												</ul>
											</div>
										</li>
						...
						<div class="portable-editor to-left" style="display: block;">
							<div class="editor-inner">
								...
								<div class="we7-form we7-padding-top">
									...
									<div class="menu-content" <?php  if($_W['account']['level'] == '1') { ?>style="display:none;"<?php  } ?> ng-show="(context.activeItem.type == 'view' || context.activeItem.type == 'miniprogram')  && context.activeItem.forceHide == 0">
									<div class="form-group">
										...
										<div class="form-controls col-sm-12" ng-show="context.activeItem.type == 'miniprogram'">
											...
											<div class="form-controls col-sm-7">
												<input type="text" class="form-control" id="ipt-url-appid" ng-model="context.activeItem.appid" ng-disabled="context.group.disabled" placeholder="请确保小程序与公众号已关联">
										...
										<div class="form-controls col-sm-12" ng-show="context.activeItem.type == 'miniprogram'">
											...
											<div class="form-controls col-sm-10">
												<input type="text" class="form-control" id="ipt-url-url" ng-model="context.activeItem.url" ng-disabled="context.group.disabled" placeholder="旧版微信客户端不支持小程序，用户点击菜单时会打开该网页">
											</div>
										</div>
									</div>
								</div>
