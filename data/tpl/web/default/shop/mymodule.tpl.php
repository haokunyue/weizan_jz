...
.nav2>li{height:50px;padding-top:16px;position:relative;display:block}
			...
			<div class="biz-module clearfix">
				...
				<?php  if(is_array($modules)) { foreach($modules as $row) { ?>
					<div class="item2" data-title=<?php  echo $row['title'];?> data-type=<?php  echo $row['type'];?>>
						<div class="biz-div">
							<a href="<?php  echo url('shop/morder/post', array('module' =>$row['name']))?>" class="pull-left biz-icon">
							...
							<div class="biz-info-0">
								<a href="<?php  echo url('shop/morder/post', array('module' =>$row['name']))?>" title="<?php  echo $row['title'];?>">
								...
								<div class="biz-div-0">
										...
										<a href="<?php  echo url('shop/morder/post', array('module' =>$row['name']))?>" class="pull-right biz-buy-btn btn btn-warning btn-sm">购买</a>
										<?php  } ?>
				<!--						<?php  if(!in_array($row['name'],$taocmd) && $moduletime[$row['name']]) { ?>
										...
										<?php  if(!in_array($row['name'],$taocmd) && $moduletime[$row['name']]) { ?>
										  ...
										  <?php  } ?>
										<a href="<?php  echo url('shop/morder/post', array('module' =>$row['name']))?>" class="pull-right biz-buy-btn btn btn-success btn-sm">续费</a>
										<?php  } ?>
				<!--						<?php  if($itemzt['status']=='2') { ?>
										<a href="<?php  echo url('shop/morder/post', array('module' =>$row['name']))?>" class="pull-right biz-buy-btn btn btn-warning btn-sm">到期禁用</a>
										<?php  } ?>-->
								</div>
								<div class="biz-div-1">
							...
							<div class="biz-info-1">
								<a href="#" class="pull-left" style="width:180px">
