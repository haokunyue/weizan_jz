...
<div class='fui-cell-group diyform-container'>
    ...
    <div class='fui-cell-info' <?php  if($v1['data_type'] == 13) { ?>style="white-space:normal;"<?php  } ?>>
        ...
        <label class="checkbox-inline">
            <input type="checkbox" class='fui-checkbox fui-checkbox-danger' name='field_data<?php  echo $i?>[]' <?php  if(is_array($f_data[$k1]) &&  in_array($v2, $f_data[$k1])) { ?>checked<?php  } ?> value="<?php  echo $v2?>"/> <?php  echo $v2?>
        </label>
        <?php  } } ?>
    ...
    <div class="diyform-pulldown2">
        <input type="text" class='fui-input datepicker'  id="field_data<?php  echo $i?>_0" name='field_data<?php  echo $i?>' placeholder="开始日期" value='<?php  if(!empty($f_data[$k1]['0'])) { ?><?php  echo $f_data[$k1]['0']?><?php  } ?>' style='width:100%;float:left;background: #f3f3f3;text-indent: .5rem;;border-radius: .1rem' readonly/>
    </div>
    <span style="float: left;display: inline-block;margin: 0 .5rem;color: #000;">至</span>
    <div class="diyform-pulldown2" >
        <input type="text" class='fui-input datepicker'  id="field_data<?php  echo $i?>_1" name='field_data<?php  echo $i?>' placeholder="结束日期" value='<?php  if(!empty($f_data[$k1]['1'])) { ?><?php  echo $f_data[$k1]['1']?><?php  } ?>' style='width:100%;float:left;background: #f3f3f3; text-indent: .5rem;;border-radius: .1rem;' readonly/>
    </div>
...
<div class="diyform-pulldown">
    ...
    <div class="diyform-pulldown2">
        <input type="text" class='fui-input timepicker'  id="field_data<?php  echo $i?>_0" name='field_data<?php  echo $i?>' placeholder="开始时间" value='<?php  if(!empty($f_data[$k1]['0'])) { ?><?php  echo $f_data[$k1]['0']?><?php  } ?>' style='width:100%;float:left;background: #f3f3f3; text-indent: .5rem;;border-radius: .1rem;' readonly/>
    </div>
    <span style="float: left;display: inline-block;margin: 0 .5rem;color: #000;">至</span>
    <div class="diyform-pulldown2" >
        <input type="text" class='fui-input timepicker'  id="field_data<?php  echo $i?>_1" name='field_data<?php  echo $i?>' placeholder="结束时间" value='<?php  if(!empty($f_data[$k1]['1'])) { ?><?php  echo $f_data[$k1]['1']?><?php  } ?>' style='width:100%;float:left;background: #f3f3f3; text-indent: .5rem;;border-radius: .1rem;' readonly/>
    </div>
    ...
    <label class="radio-inline">
        <input type="radio" class='fui-radio fui-radio-danger' id="field_data<?php  echo $i?>" name='field_data<?php  echo $i?>' <?php  if($k2 == 0) { ?> data-checked="true"<?php  } ?> value="<?php  echo $v2?>"/> <?php  echo $v2?>
    </label>
     <?php  } } ?>
    <?php  } ?>
