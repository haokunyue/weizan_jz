...
<div class="fui-navbar bottom-buttons" style="background: <?php  echo $diypage['navbar']['style']['background'];?>;">
    ...
    <a  class="nav-item btn buybtn" style="background: <?php  echo $diypage['navbar']['style']['buycolor'];?>;"  data-type="<?php  echo $goods['type'];?>"><?php echo !empty($diypage['navbar']['params']['textbuy'])?$diypage['navbar']['params']['textbuy']:"立刻购买"?></a>
    <?php  } else { ?>
...
<script language="javascript">
    require(['biz/goods/detail'], function (modal) {
        modal.init({
            ...
            close_preview:<?php  echo $close_preview;?>//是否关闭商品详情图片的放大预览
        });
    });
