...
<footer id="footer-nav">
                <ul class="menu-list" style="margin:0">
                    ...
                    <li <?php  if($footer_current=='second') { ?>class='active'<?php  } ?> id="shsh"><a<?php  if($shopset['category2']==1) { ?> <?php  } else { ?> href="<?php  echo $this->footer['second']['url']?>"<?php  } ?>><i class="fa fa-<?php  echo $this->footer['second']['ico']?>"></i><span><?php  echo $this->footer['second']['text']?></span></a></li>
                <?php  if($this->footer['commission']) { ?>
